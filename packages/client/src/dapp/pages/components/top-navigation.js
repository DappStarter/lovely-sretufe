...
export default class TopNavigation extends LitElement {
  ...
  getPages() {
    ...
    return staticPages.concat([{"name":"administrator_role","title":"Administrator Role","description":"Define accounts that can perform certain admin functions.","category":"Access Control","route":"/administrator_role"},{"name":"basic_nft","title":"Basic Non-fungible Token","description":"Create a simple non-fungible token for tracking unique assets associated with your dapp.","category":"Non-fungible Tokens","route":"/basic_nft"},{"name":"ballot","title":"Basic voting using a ballot","description":"Create a simple voting system with a ballot.","category":"Voting","route":"/ballot"},{"name":"contract_access","title":"Contract Access","description":"Control which external contracts can interact with your contract.","category":"Access Control","route":"/contract_access"},{"name":"contract_runstate","title":"Contract Run State","description":"Ability to pause operation of your smart contract.","category":"Access Control","route":"/contract_runstate"}]); 
  }
